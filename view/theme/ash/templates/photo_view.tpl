...
<div id="photo-view-{{$id}}" class="generic-page-wrapper">
	<div class="pull-left" id="photo-edit-link-wrap">
		<a class="page-action faded-icon" id="photo-album-link" href="{{$album.0}}" title="{{$album.1}}"
	...
	<div class="pull-right" id="photo-edit-link-wrap">
		{{if $tools}}
			{{if $tools.view}}
				...
				<a id="photo-edit-link" href="{{$tools.view.0}}" title="{{$tools.view.1}}" data-bs-toggle="tooltip">
					<i class="page-action faded-icon fa fa-image"></i>
				</a>
			{{/if}}
			{{if $tools.edit}}
				<span class="icon-padding"> </span>
				<a id="photo-edit-link" href="{{$tools.edit.0}}" title="{{$tools.edit.1}}" data-bs-toggle="tooltip">
					<i class="page-action faded-icon fa fa-pencil"></i>
				</a>
			{{/if}}
			{{if $tools.delete}}
				<span class="icon-padding"> </span>
				<a id="photo-edit-link" href="{{$tools.delete.0}}" title="{{$tools.delete.1}}" data-bs-toggle="tooltip">
					<i class="page-action faded-icon fa fa-trash"></i>
				</a>
			{{/if}}
			{{if $tools.profile}}
				<span class="icon-padding"> </span>
				<a id="photo-toprofile-link" href="{{$tools.profile.0}}" title="{{$tools.profile.1}}" data-bs-toggle="tooltip">
	...
	<div id="photo-view-wrapper">
		<div id="photo-photo">
			...
			<div class="photo-container">
				<a href="{{$photo.href}}" title="{{$photo.title}}"><img src="{{$photo.src}}"
						alt="{{$photo.filename}}" /></a>
			</div>
