...
<script type="text/javascript" src="{{$baseurl}}/view/theme/ash/js/jot.js?v={{$smarty.const.FRIENDICA_VERSION}}">
</script>
...
<script type="text/javascript">
			...
			.on('submit', '#profile-jot-form', function(e) {
				...
				$.ajax({
					...
					.always(function() {
						...
						let new_post_id_random = Math.floor(Math.random() * (Number.MAX_SAFE_INTEGER - (
							Number.MAX_SAFE_INTEGER / 10))) + Number.MAX_SAFE_INTEGER / 10;
	...
	function deleteCheckedItems() {
		...
		$.post('item', { dropitems: checkedstr }, function(data) {}).done(function() {
