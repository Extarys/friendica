{{* important notes: The ash theme hides under certain conditions some parts of the templates through css.
			...
			<div class="row">
				...
				<div class="col-md-8 ">
					...
					<div class="col-md-8">
						...
						{{if $s}}
							<a href="search/saved/add?term={{$q}}&amp;return_url={{$return_url}}"
								class="btn btn-primary btn-small pull-right">{{$save_label}}</a>
						{{/if}}
