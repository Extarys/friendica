<div id="sidebar-photos-albums" class="widget">
	...
	<div class="pull-right">
		{{if $can_post}}
			<div class="photos-upload-link">
				<a href="{{$upload.1}}" title="{{$upload.0}}" class="widget-action faded-icon" data-bs-toggle="tooltip">
	...
	<ul role="menubar" class="sidebar-photos-albums-ul clear">
		<li role="menuitem" class="sidebar-photos-albums-li">
			<a href="{{$baseurl}}/photos/{{$nick}}" class="sidebar-photos-albums-element"
				title="{{$title}}">{{$recent}}</a>
		</li>
