...
const ash_SCHEME_ACCENT_BLUE   = '#1e87c2';
const ash_SCHEME_ACCENT_RED    = '#b50404';
const ash_SCHEME_ACCENT_PURPLE = '#a54bad';
const ash_SCHEME_ACCENT_GREEN  = '#218f39';
const ash_SCHEME_ACCENT_PINK   = '#d900a9';

function ash_init(App $a)
{
	global $ash;
	$ash = 'view/theme/ash';
...
{
	Hook::register('prepare_body_final', 'view/theme/ash/theme.php', 'ash_item_photo_links');
	Hook::register('item_photo_menu', 'view/theme/ash/theme.php', 'ash_item_photo_menu');
	Hook::register('contact_photo_menu', 'view/theme/ash/theme.php', 'ash_contact_photo_menu');
	Hook::register('nav_info', 'view/theme/ash/theme.php', 'ash_remote_nav');
	Hook::register('acl_lookup_end', 'view/theme/ash/theme.php', 'ash_acl_lookup');
	Hook::register('display_item', 'view/theme/ash/theme.php', 'ash_display_item');

	Logger::log('installed theme ash');
}
 ...
 */
function ash_item_photo_links(App $a, &$body_info)
{
	$occurence = 0;
 ...
 */
function ash_item_photo_menu(App $a, &$arr)
{
 ...
 */
function ash_contact_photo_menu(App $a, &$args)
{
	$cid = $args['contact']['id'];
 ...
 */
function ash_acl_lookup(App $a, &$results)
{
 ...
 */
function ash_display_item(App $a, &$arr)
{
