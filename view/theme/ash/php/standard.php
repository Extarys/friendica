...
<head>
	...
	<script type="text/javascript">var ash="<?php echo "view/theme/ash"; ?>";</script>
	<?php $baseurl = Friendica\DI::baseUrl(); ?>
	<?php $ash = "view/theme/ash"; ?>
...
$("nav").bind('nav-update', function(e,data)
{
	...
	if (count>0)
	{
		...
		/* document.getElementById('notifsound').innerHTML='<object type="audio/mpeg" width="0" height="0" data="<?=$ash?>/audios/901.mp3"><param name="notif" value="<?=$ash?>/audios/901.mp3" /><param name="autostart" value="true" /><param name="loop" value="false" /></object>'; */
	}
	else
	{
...
<script src="<?=$ash?>/js/theme.js"></script>
<script src="<?=$ash?>/frameworks/bootstrap/js/bootstrap.min.js"></script>
<script src="<?=$ash?>/frameworks/jasny/js/jasny-bootstrap.min.js"></script>
<script src="<?=$ash?>/frameworks/bootstrap-select/js/bootstrap-select.min.js"></script>
<script src="<?=$ash?>/frameworks/ekko-lightbox/ekko-lightbox.min.js"></script>
<script src="<?=$ash?>/frameworks/justifiedGallery/jquery.justifiedGallery.min.js"></script>
